...
class UserAHomePage extends ConsumerWidget {
  const UserAHomePage({super.key});
        ...
        const SizedBox(
          ...
          const SizedBox(
            ...
            child: Consumer(builder: (context, ref, child) {
              List<Message> messages = ref.watch(messageNotifierProvider(To.A));
              if (messages.isEmpty) {
                return const Card(
                  child: Center(
